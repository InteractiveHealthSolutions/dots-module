...
public class TB07Controller {
    ...
    @RequestMapping(method=RequestMethod.GET, value="/module/dotsreports/reporting/tb07")
    ...
    public String doTB03(
    	...
    	Concept positiveConcept =  Context.getService(TbService.class).getConcept(TbConcepts.POSITIVE);
    	Concept negativeConcept =  Context.getService(TbService.class).getConcept(TbConcepts.NEGATIVE);
    	/*Concept hivDateConcept = Context.getService(TbService.class).getConcept(TbConcepts.DATE_OF_HIV_TEST);
    	Concept artStartConcept = Context.getService(TbService.class).getConcept(TbConcepts.DATE_OF_ART_TREATMENT_START);
    	Concept pctStartConcept = Context.getService(TbService.class).getConcept(TbConcepts.DATE_OF_PCT_TREATMENT_START);*/
    	...
    	for (Integer i : idSet) {
    	    ...
    	    if(obsList.size()>0 && obsList.get(0)!=null) {
    	    	...
    	    	else if(obsList.get(0).getValueCoded().getConceptId().intValue()==negativeConcept.getConceptId().intValue()) {
