...
public class TB08Controller {
    ...
    @RequestMapping(method=RequestMethod.GET, value="/module/dotsreports/reporting/tb08")
    ...
    @RequestMapping(method=RequestMethod.POST, value="/module/dotsreports/reporting/tb08")
    public static String doTB08(
    	...
    	Concept pulmonaryConcept = Context.getService(TbService.class).getConcept(TbConcepts.PULMONARY_TB);
    	Concept extrapulmonaryConcept = Context.getService(TbService.class).getConcept(TbConcepts.EXTRA_PULMONARY_TB);
    	...
    	for (Integer i : idSet) {
    	    ...
    	    if(obsList.size()>0 && obsList.get(0)!=null && obsList.get(0).getValueNumeric()!=null)
    	    	ageAtRegistration = obsList.get(0).getValueNumeric().intValue();
    	    	 ...
    	    	 q = Context.getService(TbService.class).getConcept(TbConcepts.AGE_AT_MDR_REGISTRATION);
    	    ...
    	    {
    	    	if(obsList.get(0).getValueCoded().getConceptId().intValue()==pulmonaryConcept.getConceptId().intValue()) {
    	    		pulmonary = Boolean.TRUE;
    	    		System.out.println("PULMONARY");
    	    	}
    	    	
    	    	else if (obsList.get(0).getValueCoded().getConceptId().intValue()==extrapulmonaryConcept.getConceptId().intValue()) {
    	    ...
    	    bacPositive = TB07Util.isBacPositive(patient);
    	    ...
    	    if(obsList ==null || obsList.size()==0) {
    	    	...
    	    	q = Context.getService(TbService.class).getConcept(TbConcepts.MDR_TB_TX_OUTCOME);
        	    conceptQuestionList.clear();
        	    conceptQuestionList.add(q);
        	    obsList = Context.getObsService().getObservations(patientList, null, conceptQuestionList, null, null, null, null, null, null, startDate, endDate, false);
    	    }
    	    ...
    	    if(obsList.size()>0 && obsList.get(0)!=null) {
    	    	...
    	    	if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.cured.conceptId"))) {
    	    		cured = Boolean.TRUE;
    	    		System.out.println("CURED");
    	    		
    	    	}
    	    	
    	    	else if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.txCompleted.conceptId"))) {
    	    		txCompleted = Boolean.TRUE;
    	    		System.out.println("TxC");
    	    	}
    	    	
    	    	else if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.txFailure.conceptId"))) {
    	    		failed = Boolean.TRUE;
    	    		System.out.println("FAIL");
    	    	}
    	    	
    	    	else if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.died.conceptId"))) {
    	    		...
    	    		q = Context.getService(TbService.class).getConcept(TbConcepts.CAUSE_OF_DEATH);
    	     	    ...
    	     	    if(obsList.size()>0 && obsList.get(0)!=null)
    	     	    {	
    	     	    	if(obsList.get(0).getValueCoded().getConceptId().intValue() == Context.getService(TbService.class).getConcept(TbConcepts.DEATH_BY_TB).getConceptId().intValue())
    	     	    		diedTB = Boolean.TRUE;
    	     	    	else
    	    	...
    	    	else if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.ltfu.conceptId"))) {
    	    		defaulted = Boolean.TRUE;
    	    		System.out.println("DEF");
    	    	}
    	    	
    	    	else if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.canceled.conceptId"))) {
    	    		canceled = Boolean.TRUE;
    	    		System.out.println("CANCEL");
    	    	}
    	    	
    	    	else if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.transferout.conceptId"))) {
    	    		transferOut = Boolean.TRUE;
    	    		System.out.println("TOUT");
    	    	}
    	    	
    	    	else if(outcomeId == Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.outcome.sld2.conceptId"))) {
    	    		sld = Boolean.TRUE;
    	    ...
    	    if(obsList.size()>0 && obsList.get(0)!=null) {
    	    	...
    	    	if(obsList.get(0).getValueCoded().getConceptId().intValue()!=Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.transferIn.conceptId"))) {
    	    	...
    	    	//NEW
    	    	if(obsList.get(0).getValueCoded().getConceptId().intValue()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.new.conceptId"))) {
    	    	...
    	    	//RELAPSE
    	    	else if(obsList.get(0).getValueCoded().getConceptId().intValue()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.afterRelapse1.conceptId")) || obsList.get(0).getValueCoded().getConceptId()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.afterRelapse2.conceptId"))) {
    	    	...
    	    	//FAILURE
    	    	else if(obsList.get(0).getValueCoded().getConceptId().intValue()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.afterFailure1.conceptId")) || obsList.get(0).getValueCoded().getConceptId()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.afterFailure2.conceptId"))) {
    	    	...
    	    	else if(obsList.get(0).getValueCoded().getConceptId().intValue()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.afterDefault1.conceptId")) || obsList.get(0).getValueCoded().getConceptId()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.afterDefault2.conceptId"))) {
    	    	...
    	    	//OTHER
    	    	else if (obsList.get(0).getValueCoded().getConceptId().intValue()==Integer.parseInt(Context.getAdministrationService().getGlobalProperty("dotsreports.other.conceptId"))) {
    	...
    	boolean reportStatus = Context.getService(TbService.class).readReportStatus(report_oblast, location.getId(), year, report_quarter, report_month, "TB 08");
