...
@Controller
public class CloseReportChangesDOTSController {
	...
	@RequestMapping(method=RequestMethod.GET, value="/module/dotsreports/reporting/viewClosedReportChanges")
    public void viewClosedReports(ModelMap model) {
		System.out.println("-----View Closed Report Changes GET-----");
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(method=RequestMethod.POST)//, value="/module/dotsreports/reporting/viewClosedReportChanges"
    public ModelAndView viewClosedReportsPost(
		...
		/*DOTSTB EncounterTypes For Report Generation*/
		...
		List<Encounter> encounters = (List<Encounter>) Context.getService(TbService.class).getEncountersByEncounterTypes(reportEncounterTypes, startDate, endDate, null);
		if(encounters != null) {
		...
		return new ModelAndView("/module/dotsreports/reporting/viewClosedReportChanges", model);
	}
}