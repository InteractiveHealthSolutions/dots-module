...
import org.openmrs.module.dotsreports.specimen.SpecimenConstants.TestStatus;
...
public abstract class TestImpl implements Test {
	...
	public Date getStartDate() {
	 ...
	 public String getRealSpecimenId() {
		 ...
		 encounters.add(enc);
		 Concept question = Context.getService(TbService.class).getConcept(TbConcepts.SPECIMEN_ID);
