 ...
 */
@Handler(supports={AgeAtMdrtbProgramEnrollmentCohortDefinition.class},order=20)
public class AgeAtMdrtbProgramEnrollmentCohortDefinitionEvaluator extends ProgramEnrollmentCohortDefinitionEvaluator {
	
	/**
	 * Default Constructor
	 */
	public AgeAtMdrtbProgramEnrollmentCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
    	...
    	AgeAtMdrtbProgramEnrollmentCohortDefinition cd = (AgeAtMdrtbProgramEnrollmentCohortDefinition) cohortDefinition;
