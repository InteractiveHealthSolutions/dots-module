 ...
 */
@Handler(supports={DotsMdrtbProgramLocationCohortDefinition.class})
public class DotsMdrtbProgramLocationCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public DotsMdrtbProgramLocationCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
      	...
      	DotsMdrtbProgramLocationCohortDefinition cd = (DotsMdrtbProgramLocationCohortDefinition) cohortDefinition;
