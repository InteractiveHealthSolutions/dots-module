...
@Handler(supports={DotsPatientProgramStateCohortDefinition.class})
public class DotsPatientProgramStateCohortDefinitionEvaluator implements CohortDefinitionEvaluator  {

	/**
	 * Default Evaluator
	 */
	public DotsPatientProgramStateCohortDefinitionEvaluator(){
	}
	
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
	
    	DotsPatientProgramStateCohortDefinition cd = (DotsPatientProgramStateCohortDefinition) cohortDefinition;
