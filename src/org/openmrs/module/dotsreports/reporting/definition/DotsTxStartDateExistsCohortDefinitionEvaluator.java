 ...
 */
@Handler(supports={DOTSTxStartDateExistsCohortDefinition.class})
public class DotsTxStartDateExistsCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public DotsTxStartDateExistsCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
    	...
    	DOTSTxStartDateExistsCohortDefinition cd = (DOTSTxStartDateExistsCohortDefinition) cohortDefinition;
    	//Cohort c = null;
