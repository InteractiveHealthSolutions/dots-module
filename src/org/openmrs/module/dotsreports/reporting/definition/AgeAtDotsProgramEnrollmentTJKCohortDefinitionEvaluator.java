 ...
 */
@Handler(supports={AgeAtDotsProgramEnrollmentTJKCohortDefinition.class},order=20)
public class AgeAtDotsProgramEnrollmentTJKCohortDefinitionEvaluator extends ProgramEnrollmentCohortDefinitionEvaluator {
	
	/**
	 * Default Constructor
	 */
	public AgeAtDotsProgramEnrollmentTJKCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
    	...
    	AgeAtDotsProgramEnrollmentTJKCohortDefinition cd = (AgeAtDotsProgramEnrollmentTJKCohortDefinition) cohortDefinition;
