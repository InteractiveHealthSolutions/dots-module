...
@Localized("dotsreports.reporting.DotsMdrtbPatientProgramStateCohortDefinition")
public class DotsMdrtbPatientProgramStateCohortDefinition extends BaseCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public DotsMdrtbPatientProgramStateCohortDefinition() {
		super();
	}
