		...
		<tr>
			<td width="25%" valign="top" class="patientTable">
				<table>
					...
					<tr><th colspan="2"><spring:message code="dotsreports.oblast" text="Oblast"/>
							<select name="oblast">
								<option value=""></option>
				...
				<!-- 	<tr><td colspan="2">
					...
					<tr>
						...
						<td><input type="text" name="quarter" value="${quarter}"/>
					</tr>
					<tr>
						<td><spring:message code="dotsreports.or"/></td>
					<tr>
					<tr>
						<td><spring:message code="dotsreports.month"/></td>
