...
<html>
	...
	<body>
		<h2>
			<center><spring:message code="dotsreports.viewClosedReports" /></center>
		</h2>
		<br/>
		<table class="display" id="myTable" border="1">
			<thead>
				<tr>
					<th><spring:message code="dotsreports.viewClosedReports.oblast" /></th>
					<th><spring:message code="dotsreports.viewClosedReports.district" /></th>
					<th><spring:message code="dotsreports.viewClosedReports.year" /></th>
					<th><spring:message code="dotsreports.viewClosedReports.quarter" /></th>
					<th><spring:message code="dotsreports.viewClosedReports.month" /></th>
					<th><spring:message code="dotsreports.viewClosedReports.reportName" /></th>
					<th><spring:message code="dotsreports.viewClosedReports.reportDate" /></th>
					<th colspan="2"></th>
				</tr>
			</thead>
		...
		<script>
			...
			if("${reportIds}"=== "[]") {
				...
				<c:forEach var="reportId" items="${reportIds}" varStatus="reportIdLoop">
					...
					var viewBtnTxt = "<spring:message code='dotsreports.viewClosedReports.viewBtn' />";
					var unlockBtnTxt = "<spring:message code='dotsreports.viewClosedReports.unlockBtn' />";
			...
			function unlock(id) { 
				if(confirm('<spring:message code="dotsreports.unlockClosedReportMessage" />')) {
...
<%@ include file="/WEB-INF/view/module/dotsreports/dotsFooter.jsp"%>