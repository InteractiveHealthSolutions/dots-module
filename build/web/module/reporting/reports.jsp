				...
				<tr>
					<td style="border:1px solid black; padding:5px;">
						<form id="reportParameterForm" action="render.form" target="reportData">
							...
							<%-- <b><spring:message code="dotsreports.facility"/></b><br/>
							...
							<select name="format">
								...
								<option value=""><spring:message code="dotsreports.preview"/></option>
							</select>
							<br/><br/>
							<input type="submit" id="actionButton" value="<spring:message code="dotsreports.run"/>" />
							<input type="button" id="cancelButton" value="<spring:message code="dotsreports.close"/>" />
						</form>
					</td>
